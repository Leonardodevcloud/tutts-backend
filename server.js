...
const { initMaquinasRoutes, initMaquinasTables } = require('./src/modules/maquinas');
...
// 🆕 Fase 6 — módulo uber legado removido (sunset). Hub Logístico assumiu.
...
// 🆕 Fase 6 — webhook /api/uber/webhook removido junto do módulo uber legado.
