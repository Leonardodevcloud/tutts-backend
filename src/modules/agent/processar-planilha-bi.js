...
const COLUNAS_FINAIS = [
  ...
  'Distância', 'Valor prof.', 'Valor adicionado (profissional)', 'Preço dinâmico (valor)', 'Valor adicionado (cliente)', 'Valor liquido', 'Finalizado',
...
function paraSnakeCase(linhasTratadas) {
  return linhasTratadas.map(e => ({
    ...
    valor_adic_prof:             e['Valor adicionado (profissional)'],
    preco_dinamico:              e['Preço dinâmico (valor)'],
    valor_adic_cliente:          e['Valor adicionado (cliente)'],
