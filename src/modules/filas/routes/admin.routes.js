    ...
    try {
      ...
      const result = await pool.query(`
        ...
        SET nome                     = COALESCE($1,  nome),
            ...
            validacao_agente_ativa   = COALESCE($8,  validacao_agente_ativa),
            varredura_intervalo_seg  = COALESCE($9,  varredura_intervalo_seg),
            remover_ao_pegar_corrida = COALESCE($10, remover_ao_pegar_corrida),
            mostrar_nomes_publicos   = COALESCE($11, mostrar_nomes_publicos),
